...
| ----- | --------- | ----- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Advisory  | CIB   | Live   | DOCRB-005 link review 2026-08-20 confirmed the CIB-343 handshake evidence against `mcp_client.rs::all_clients` / `probe_all` and `agent_registry.rs`; prior CIB-344 review 2026-08-19 and original measurement 2026-08-16 |

| Upstream                                                                                                                                                                                                                                                                               | Downstream   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `docs/guides/ai-context-delivery.md`, `crates/anvil-cli/ARCHITECTURE.md`, `crates/anvil-intercept/src/full_scan_executor.rs`, `crates/anvil-intercept/src/graph_base_trigger.rs`, `crates/anvil-cli/src/activation/mcp_client.rs`, `crates/anvil-cli/src/activation/agent_registry.rs` | CIB-341..344 |
