...
| ----- | ------------- | -------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Guide | Authoritative | DISTRIB ([`plans/archive/modules/distribution-and-update.aps.md`](../../plans/archive/modules/distribution-and-update.aps.md)) | Live   | Amended 2026-06-01: six-week minor-beta cadence hold retired (authorised by Josh — funding velocity). Prior: reviewed 2026-05-16 against `plans/specs/2026-05-14-release-plan-v0.7.0-sit-on.md` and `plans/aps-rules.md` |
