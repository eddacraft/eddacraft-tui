...
- Every rule includes deterministic detection, short explanation, deterministic
  suggestions, and suppression support with reason.
...
- enable/disable rules, adjust thresholds, override messages/suggestions, add
  new rules
