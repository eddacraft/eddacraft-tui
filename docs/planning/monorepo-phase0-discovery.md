...
> **Context:** Pre-Phase 1 discovery to establish accurate migration boundaries

---

## Executive Summary

This document captures the findings from Phase 0 discovery tasks (MONO-000a through MONO-000d).
The discovery revealed significant gaps between the documented plan and actual codebase state:
...
├── core/                    # @anvil/core - PRODUCTION (41,580 lines)
...
**Implication:** No actual migration needed for apps/ structure - scaffolds exist.
...
| __fixtures__/ | 0 | 0 | Test fixtures |
...
**Location:** `packages/edda-stack/`
**Total Lines:** 10,422
**Status:** Production code (not a placeholder)
...
**Location:** `packages/kindling-integration/`
**Total Lines:** ~500
**Files:** 3
...
*Next phase: MONO-001 (Nx generators)*
