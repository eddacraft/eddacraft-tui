...
## Core problem
Second-wave feature work drifts from intended patterns; biggest pain is structural boundary crossing via new dependency edges.
...
## Anti-patterns
- High-confidence warnings for AI escape hatches (eslint disables, `any`, broad ignores).
...
## Impact
Prefer runtime/product impact; ideally user journeys/features.
Start deterministically from runtime entry points; careful language; show low-confidence explicitly only when low.
