...
| Upstream                                                                                   | Downstream                                                                                                                   |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| `plans/modules/documentation-governance.aps.md`, `docs/guides/documentation-governance.md` | `scripts/docs/check-tags.mjs`, `scripts/docs/docs-check.mjs`, future generated indexes (DOCGOV-007), DOCGOV-008 cleanup pass |
