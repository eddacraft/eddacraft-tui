...
| -------- | --------- | ------ | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| As-built | Derived   | @aneki | Live   | 2026-07-02 (`admin-cli-node` moved to sibling `eddacraft/anvil-archive`, V060F-019 2026-06-19; api-as-built G-04 records it — reclassified to "Archived surfaces" below; prior 2026-05-20 drift-fix on #1216, see "Drift notes") |
...
| `packages/shared/admin-contracts` | Shared admin contracts between API and admin-cli.                      | release-blocking     | Nx `test`, Type Check        | Co-released with `apps/anvil-api`; the former in-repo `admin-cli-node` consumer moved to sibling `eddacraft/anvil-archive` (V060F-019, 2026-06-19), so its only in-repo consumer is now `apps/anvil-api`.                                                                         |
...
- `anvil-archive/admin-cli-node` — moved out on 2026-06-19 (V060F-019; see
  `api-as-built.md` G-04). Was the sole `release-blocking` operator CLI in the
  Apps table above; it is absent from this checkout and from
  `pnpm-workspace.yaml`, so it no longer runs in release CI.
