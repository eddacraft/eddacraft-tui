...
| -------- | --------- | ------ | ------ | --------------------------------- |
| As-built | Reference | @aneki | Live   | 2026-05-16 (#1216 inventory pass) |
...
| `packages/anvil-driver-client`    | JS-side driver-client used by tests and harnesses.                     | release-blocking     | Nx `test`, Type Check        | Imported by `apps/e2e`.                                                           |
...
| `packages/libs/render`            | Rendering primitives for architecture-health dashboard.                | compatibility-canary | Nx `test`, Type Check        | Internal dashboard; not in the install bundle.                                    |
...
| `packages/shared/storage`         | Storage adapters used by API/CLI.                                      | release-blocking     | Nx `test`, Type Check        | Imported by anvil-api.                                                            |
