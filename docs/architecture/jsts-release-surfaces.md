...
| `packages/shared/admin-contracts` | Shared admin contracts between API and admin-cli.                      | release-blocking     | Nx `test`, Type Check        | Co-released with `apps/anvil-api` / `apps/admin-cli`.                                                                                                                                                                                                                             |
