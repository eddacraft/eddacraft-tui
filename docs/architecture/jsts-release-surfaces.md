...
| ------------------------- | ------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| `archive/admin-cli-node`          | Node CLI shipped to operators of the waitlist + admin surface.                                    | release-blocking     | `ci.yml` Lint & Format, Type Check, Unit Tests, Build  | First-party operator tool. Has tests and an Nx `build` target; lives in the integration-readiness aggregator. |
...
| `packages/shared/admin-contracts` | Shared admin contracts between API and admin-cli.                      | release-blocking     | Nx `test`, Type Check        | Co-released with `apps/anvil-api` / `archive/admin-cli-node`.                                                                                                                                                                                                                             |
