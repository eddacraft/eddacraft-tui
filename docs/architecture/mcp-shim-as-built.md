...
| ----------------- | ----------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `workspaceRoot`   | string (absolute path)                          | no                                          | Defaults to the shim's cwd. Must match the shim cwd if provided; a mismatch yields `untrusted-workspace-root` whose error payload carries `expectedWorkspaceRoot` (the shim's canonicalised cwd) so callers can self-correct (CIB-007).                                                                                                                                                                                                                                                                 |
