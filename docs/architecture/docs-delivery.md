...
| ----- | ------------- | --------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | DOCRB/DSITE gap | Live   | Last reviewed 2026-08-24 against the live docs-shell entitlement path, renderer boundaries, content sources, deployment wiring, and build watches; reviewed after CPACKS-007 added the starter-pack known-gaps section to `docs/public/anvil/tutorials/policies.md` (prose only — no new content root, renderer, or build watch); prior review after POLFIT-001 public policy-model inventory; source/build/deploy topology and diagrams unchanged |
