...
| ----- | ------------- | --------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | DOCRB/DSITE gap | Live   | Last reviewed 2026-08-24 against the live docs-shell entitlement path, renderer boundaries, content sources, deployment wiring, and build watches; reviewed after POLFIT-007 public starter-pack residue on `docs/public/anvil/**` (prose only — no new content root, renderer, or build watch); prior review after POLFIT-008 public policy-model registry row; source/build/deploy topology and diagrams unchanged |
