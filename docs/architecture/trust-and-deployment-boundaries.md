...
| ----- | ------------- | ----- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | DOCRB | Live   | Last reviewed 2026-08-23 against local IPC clients and attribution, hosted API routes, canonical docs entitlement evaluation, renderer boundaries, and deployment wiring; reviewed after the DOCRB-009 metadata update to `apps/docs-shell/ARCHITECTURE.md`; trust topology and diagrams unchanged |
