...
> **Module owner (APS):** INTD (`plans/archive/modules/intercept-daemon.aps.md`, 16/16
> complete), INTL (`plans/modules/intercept-launcher.aps.md`, draft 0/9) **Used
...
- `plans/decisions/015-intercept-loop-enforcement.md` — AD-3 (ambiguous-
  ...
  invariant).
- `plans/archive/modules/intercept-daemon.aps.md` — INTD-001 through INTD-016 work items
  (16/16 complete).
- `plans/modules/intercept-launcher.aps.md` — INTL-001 through INTL-009 (draft
  0/9); the launcher side that registers sessions with the daemon.
