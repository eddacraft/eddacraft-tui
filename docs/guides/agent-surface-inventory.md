...
| `dependabot`              | `.claude/skills/dependabot` (symlink → `code-env`) | Dependency-update triage                                                                                                                       | Symlink target: `/home/aneki/Projects/src/code-env/.claude/skills/dependabot`.                                                                                                  |
| `dev-workflow` (OpenCode) | `.opencode/skills/dev-workflow/SKILL.md`           | OpenCode-native parallel of the Claude `dev-workflow` skill                                                                                    | Same routing knowledge, OpenCode skill schema (per `https://opencode.ai/docs/skills/`).                                                                                         |
...
| -------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `aps-planning`                   | `code-env/.claude/skills/aps-planning/`                   | `AGENTS.md` quick-reference table                                               |
...
| `addressing-pr-reviews`          | `code-env/.claude/skills/addressing-pr-reviews/`          | `dev-workflow` Stage Map (Address review)                                       |
