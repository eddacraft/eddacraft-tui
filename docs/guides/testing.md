...
| ----- | ------------- | ----- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | TEST  | Live   | Last reviewed 2026-08-21: the `AGENTS.md` change adds a continuous-improvement closeout section only — this guide covers neither closeout nor the ci-log, so nothing here changed. Also reviewed against `Cargo.toml` (workspace version `0.9.7-beta` prepare bump; animation crate exact-pinned `animate-core =0.4.1`) and earlier `.github/workflows/rust-tests.yml` (CIB-338 made the paths-filter gate on the required `Test` check fail open — documented under CI Flake Triage), `.github/workflows/ci.yml` (CIB-335 parity step), `.github/workflows/rust.yml`, `AGENTS.md`, `plans/project-context.md`, and AICON-002 |
