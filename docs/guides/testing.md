...
| ----- | ------------- | ----- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | TEST  | Live   | Last reviewed 2026-08-25 for FLAGCAT-012 catalogue path filters on rust-tests; testing procedure unchanged. Also reviewed against `Cargo.toml`, `.github/workflows/rust-tests.yml`, `.github/workflows/ci.yml`, `.github/workflows/rust.yml`, `AGENTS.md`, `plans/project-context.md`, and AICON-002 |
