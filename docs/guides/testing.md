...
| ----- | ------------- | ----- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | TEST  | Live   | Last reviewed 2026-08-16 against `Cargo.toml` (workspace animation crate is now exact-pinned `animate-core`; the unused `animate`/`animate-macros` proc-macro path is gone) and earlier `.github/workflows/rust-tests.yml` (CIB-338 made the paths-filter gate on the required `Test` check fail open — documented under CI Flake Triage), `.github/workflows/ci.yml` (CIB-335 parity step), `.github/workflows/rust.yml`, `AGENTS.md`, `plans/project-context.md`, and AICON-002 |
