...
| ----- | ------------- | ----- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Guide | Authoritative | TEST  | Live   | Last reviewed 2026-08-20 against `Cargo.toml` (workspace version `0.9.6-beta` prepare bump; animation crate remains exact-pinned `animate-core`) and earlier `.github/workflows/rust-tests.yml` (CIB-338 made the paths-filter gate on the required `Test` check fail open — documented under CI Flake Triage), `.github/workflows/ci.yml` (CIB-335 parity step), `.github/workflows/rust.yml`, `AGENTS.md`, `plans/project-context.md`, and AICON-002 |
