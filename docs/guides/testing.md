...
| ----- | ------------- | ----- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | TEST  | Live   | Last reviewed 2026-08-13 against `.github/workflows/rust.yml` (dorny/paths-filter pin bump 4.0.2→4.0.3 — an action-version pin, not a test-convention change, so no content change was needed) and earlier `.github/workflows/ci.yml`, `AGENTS.md`, `plans/project-context.md`, and AICON-002 |
