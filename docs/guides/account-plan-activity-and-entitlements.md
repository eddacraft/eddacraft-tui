...
| ----- | ------------- | ----- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide | Authoritative | BACT  | Live   | Last reviewed 2026-08-21: this branch's only `licence.ts` change is comment cleanup — two references to the retired docs-site host that SEC-012 left behind, now that the host is deleted. The claim-resolution rule and every other statement below are unchanged. Prior 2026-08-20 against `flags/audiences.json`, `flags/manifest.json`, `apps/anvil-api/src/lib/feature-flags.ts`, `apps/anvil-api/src/lib/licence.ts`, and ADR-121 |
