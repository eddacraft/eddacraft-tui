...
| ------- | ------------- | -------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Runbook | Authoritative | CIB, FLEET-007, BACT | Live   | Last reviewed 2026-08-24: pack-11 filed CIB-360..362 (Git Bash workspace allow, Windows mcp refresh sharing, Windows upgrade daemon-stop) — does not touch the admin CLI surface, so no operator step changed. Prior 2026-08-22: pack-10 filed CIB-359 (antipattern masker UTF-8 panic) — does not touch the admin CLI surface, so no operator step changed. Prior 2026-08-21: ci-log triage promoted CIB-354..358 (Worktrunk paths, docs discovery traversal, MCP envelope reinflation, claim-payload metadata, beta intake ID counts) — none touch the admin CLI surface, so no operator step changed. Prior 2026-08-19: CIB-141/143 restatement (rotation half on main; post-BACT-013 `tier` mirrors `plan`) does not touch CIB-004 (admin-key credential-source); prior 2026-08-19 pack-09 (CIB-349..353), 2026-08-18 CIB-341..344, 2026-08-16 CIB-339/340, 2026-08-15 CIB-336..338, 2026-08-14 pack-06 (CIB claim advance for v0.9.6-beta closeout) |
