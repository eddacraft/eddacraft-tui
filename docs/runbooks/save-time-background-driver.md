...
| Upstream                                                                                                                                                                                                                                                                                                                                                   | Downstream                                                                                                                          |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [DSV](../../plans/modules/daemon-save-time-validation.aps.md), [ADR-101](../../plans/decisions/101-headless-save-time-driver.md), [headless driver design](../../plans/specs/2026-07-04-headless-save-time-driver-design.md), [`anvil start`](../../crates/anvil-cli/src/commands/start.rs), [`anvil watch`](../../crates/anvil-cli/src/commands/watch.rs) | [Save-time validation guide](../public/anvil/guides/save-time-validation.md), [MCP-optional activation](anvil-no-mcp-activation.md) |
