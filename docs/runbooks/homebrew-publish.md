...
| Upstream                                                                                                                                                                                                                                          | Downstream                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [DISTRIB-003 in `distribution-and-update.aps.md`](../../plans/modules/distribution-and-update.aps.md), [`release-token-scope.md`](release-token-scope.md), [`v0.6.0-beta-release-runbook.md`](../archive/runbooks/v0.6.0-beta-release-runbook.md) | [`scripts/release/bump-homebrew.sh`](../../scripts/release/bump-homebrew.sh), [`.github/workflows/homebrew-bump.yml`](../../.github/workflows/homebrew-bump.yml), [`.github/workflows/release.yml`](../../.github/workflows/release.yml) |
