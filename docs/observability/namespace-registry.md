...
> [ADR-019](../../plans/decisions/019-namespace-freedom.md) (namespace freedom)
> and [ADR-035](../../plans/decisions/035-three-pipe-observability-rule.md)
> (three-pipe rule).
...
ADR-019, namespaces are free to contribute. This document is the durable record
of which namespaces exist, who owns them, and which pipe each attribute lands on
per the ADR-035 three-pipe matrix.
