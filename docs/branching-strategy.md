...
2. **Release**: PR from `dev` to `main` — triggers full CI including cross-platform (macOS/Windows)
3. **Hotfixes**: Branch from `main`, PR to `main`, then cherry-pick or merge back to `dev`
...
This strategy saves ~60-70% of CI minutes while maintaining full coverage before releases.
