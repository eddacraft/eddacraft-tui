...
This roadmap is framed around user outcomes rather than internal implementation
labels.
...
We will continue to lead with capability language in external docs: capture,
review, preserve, reuse.

Internal names (Kindling, Ember, Edda) remain useful as architectural anchors,
not as the primary value story.
