...
an _intent_ and a lifecycle. Where an
[observation](/kindling/concepts/observations) records a single event, a capsule
captures a whole episode of work — a session, or a single workflow node run.
