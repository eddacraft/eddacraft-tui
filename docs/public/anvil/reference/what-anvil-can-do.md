...
| 10  | Policy is a **gate check**; start with the `anvil-baseline` pack ([policy packs](../concepts/policy-model.md)). Authoring is the installed skill, not a public Rego manual. | shipped                  |
