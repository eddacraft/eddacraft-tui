...
| 10  | Policy is a **gate check**; start with a bundled pack (`anvil-baseline` or `anvil-control-examples`; [policy model](../concepts/policy-model.md)). Authoring is the installed skill, not a public manual. | shipped                  |
