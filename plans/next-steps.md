...
| [council-gate-bridge](./modules/council-gate-bridge.aps.md) | CGBDG | Blocked  | Deferred 2026-05-10 — blocked on MLP-002 (witness chain). The bridge target may shift once witness lines land; MLP-002's per-commit witness format may subsume what this module would design. Re-evaluate scope when MLP-002 is `Merged`; CGBDG may collapse to "council emits witness lines" rather than a separate bridge. |
