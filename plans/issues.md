...
| ISS-004 | Pulumi Preview CI check failing on main (pre-existing) | resolved | infra | medium | aneki | Resolved — Azure secrets provisioned 2026-02-15. `check-secrets` guard + credentials now work correctly. All recent infra.yml runs passing on main. |
