...
Proposed (GCALL-001). Authored as the gating design decision for the
`symbol-call-graph` (GCALL) module; acceptance ratifies the model the rest of
the module (GCALL-002..007) builds on.
