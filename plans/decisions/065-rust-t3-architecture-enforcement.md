...
- APS modules: [lang-rust](../modules/lang-rust.aps.md) (RSTLAN), [lang-ts-audit](../modules/lang-ts-audit.aps.md) (LANGTS), [multilayer-protection-v2](../modules/multilayer-protection-v2.aps.md) (context for enforcement surfaces)
...
- Code: `crates/anvil-architecture/src/validator.rs` (collect + edges), `crates/anvil-cli/src/commands/gate.rs:854` (current JS/TS filter + comment), `packages/anvil/core/src/architecture/`
