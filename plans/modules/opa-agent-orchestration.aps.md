...
> `cargo test -p anvil-policy` / `cargo test -p anvil-cli` /
> `cargo test -p anvil-kernel` suites. Dependency modules
...
- **Validation:** `cargo test -p anvil-policy -- orchestration_contract`
...
- **Validation:** `cargo test -p anvil-policy -- checkpoint_runner`
...
- **Validation:** `cargo test -p anvil-policy -- policy_guidance`
...
- **Validation:** `cargo test -p anvil-policy -- exception_workflow`
...
- **Validation:** `cargo test -p anvil-policy -- policy_audit_events`
...
- **Validation:** `cargo test -p anvil-cli -- surface_parity` (MCP surface deferred — module archived)
...
- **Validation:** `cargo test -p anvil-policy -- orchestration_performance`
