...
**Outcome:** Published on both repos 2026-07-12T17:06Z; verification and
closeout recorded; durable record at
...
- Private and public `v0.9.0-beta` releases published with the full cargo-dist
  asset set (22 / 23 assets incl. `anvil-v0.9.0-beta-provenance.json` and
...
- **PR #3309** — publication-recovery hardening (in flight, separate author).
