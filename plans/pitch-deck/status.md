...
- Precise number of engineering organisations globally with >20 developers
- **Anvil traction data**: waitlist numbers, design partners, community metrics
- **Team information**: founder bios, team composition, advisors
- **Funding details**: amount, use of funds, milestones
...
| 2026-03-18 | Phase 1 complete, gate passed | 5/5 research docs, all claims cited |
