...
| 4 | DOCRB-005 — component-truth migration and duplicate-authority retirement | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [action plan](./execution/DOCRB-005.actions.md), [corpus disposition](./specs/2026-08-17-docrb-corpus-disposition.md) | Current readiness evidence accepted; the bounded component-truth migration is executing. Not a release claim. | Complete exact-head verification and Council, then land and reconcile; do not start DOCRB-008. |
...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 7/11       | **In Progress — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002/-003/-004/-006/-007/-011 Merged (#3975/#3976/#4027/#4031/#4040/#4051/#4009). DOCRB-005 is executing against its current action plan; DOCRB-008 remains Draft and is not promoted by this work. The live sidebar unhide and live-nav check no longer wait on diagram work. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
