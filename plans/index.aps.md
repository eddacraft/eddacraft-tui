...
| [watch-ux-advisory-rules](./modules/watch-ux-advisory-rules.aps.md) | WATCHUX | In Progress | 3/8 (WATCHUX-005..007 complete; WATCHUX-001..004 hotfix underway on `fix/beta-user-bug`, WATCHUX-008 remains follow-up config/cache work) | anvil-cli audit/start/watch/status/config, anvil-kernel watch/watcher, anvil-tui watch surface, MLP config/baseline |
