...
**MLP2 audit note (2026-05-15):** the module now stands at 36/66 after the
full MLP/MLP2 Council audit reopened MLP2-016 and MLP2-048 and added Group M
(MLP2-061..066). Earlier wave prose that says those two items closed hard gates
is historical PR evidence; the current release cut-line lives in the MLP2 module
and `RELEASE-PLAN.md`.
