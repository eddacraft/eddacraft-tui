...
| [native-tui-dashboards](./modules/native-tui-dashboards.aps.md)           | TDASH   | In Progress | 0/4                                                                                                               | anvil-tui (`plan_dashboard` precedent), eddacraft-tui, RCLI; reads persisted `.anvil/` state. Parallel to TUIDASH (json-render); neither blocks the other. Gate-summary/watch-session deferred until their data persists.                                                          |
