...
| [activation-tui](./modules/activation-tui.aps.md)                     | ACTTUI   | In Progress | 18/22 | TUI-first `anvil start`. **000–017 Merged** (#3478/#3488). **ACTTUI-018..021 In Progress** on `feat/acttui-usability-followups` (quiet re-run, shared posture, settled Install, MCP prove honesty) ([spec](./specs/2026-08-03-activation-tui-completion.md)). Escape hatches: `--no-tui` / `ANVIL_NO_TUI=1`. |
