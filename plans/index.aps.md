...
| Daemon-working product slate | Current candidate | MLP 9/17 (In Progress; MLP-001 + MLP-002 + MLP-003 + MLP-006 + MLP-007 + MLP-011 + MLP-012 + MLP-013 + MLP-017 Done 2026-05-13), INTL 0/9 (Ready, ready-to-start-Wave-3), carry-forward gates 6/6 confirmed (Wave 0 closed 2026-05-13) | Next tag candidate `v0.7.0-beta`; MLP-009 remains the hard release gate for any full-protection claim. Wave 2 in flight per `RELEASE-PLAN.md`. |
...
| ---- | ------ | -------- | ----- |
| N1 — Multi-Layer Protection v1 (MLP) | In Progress | 9/17 | Witness chain + hooks + L4 policy + baseline + multi-agent coord + rule distribution. New crates: `anvil-witness`, `anvil-config`, `anvil-rules`, `anvil-baseline`, `anvil-hook`, `anvil-l4`, `anvil-attribution`. **Hard gate: MLP-009.** Promoted from Proposed during Wave 0 readiness review (2026-05-13). Wave 1 complete (MLP-001 / -002 / -011 / -013 / -017 Done 2026-05-13). Wave 2 in flight: MLP-012 already merged via PR #1489 (`crates/anvil-rules/`; 29 tests green incl. yaml/json/toml cross-format determinism); MLP-007 (#1490) and MLP-003 (#1491) merged; this PR adds MLP-006 via `crates/anvil-l4/` (Policy / BranchRule schema + globset branch resolver + cutoff_commit ancestry check; 24 tests green). Remaining Wave 2 items: MLP-005 post-* hooks, MLP-008 hook bootstrap. |
