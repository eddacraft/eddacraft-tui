...
| [daemon-lifecycle](./modules/daemon-lifecycle.aps.md)                           | DLIFE  | Proposed    | 0/5 (created 2026-06-14 from operator direction that `anvil start` and `anvil watch` should make daemon-backed protection the normal user path, with explicit opt-out. ADR-082 is Proposed and would supersede ADR-079 before implementation work proceeds.) |
