...
| [test-coverage-uplift](./modules/test-coverage-uplift.aps.md)               | TCOV  | In Progress | 24/25 (Phase 1+2 complete: 13/13; Phase 3: TCOV-014 Complete + TCOV-015..-018 Merged (4), TCOV-019..-021 Complete (covered by the Rust RMCPF MCP port #2809; archived TS target retired under ADR-033); Phase 4: TCOV-025 + TCOV-024 + TCOV-023 Merged, TCOV-022 Ready (re-scoped 2026-06-20 to `crates/eddacraft-tui/` widgets/theme/keyboard — primitives crate kept the targets after the anvil-tui split)) | TFIX                    |
