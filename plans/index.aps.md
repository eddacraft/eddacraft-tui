...
| 3 | CIB-252 + CIB-254 — pack-02 trust: register false success + daemon save-time silent miss | CIB-252 Merged; CIB-254 Ready | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3552](https://github.com/eddacraft/anvil-001/pull/3552), [RELEASE-PLAN](../RELEASE-PLAN.md) | CIB-252 register honesty landed; CIB-254 remains a P0 Windows-observed investigation. | Investigate the CIB-254 watch daemon path + degraded-label pairing. |
