...
hardened spec + ADR-094 (Proposed). The council's keystone finding: the registry
...
daemon-usefulness cut-line also needs a promoted+split **DSV-046**. Counts are
advisory (ADR-053) pending `pnpm aps:index` reconcile.
