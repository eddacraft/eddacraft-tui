...
| [tui-dashboard-render](./modules/tui-dashboard-render.aps.md)             | TUIDASH | In Progress | 2/12 (TUIDASH-002 component registry trait + `TuiRegistry` Merged 2026-05-29 via PR #2097)                         | eddacraft-tui (engine, feature-gated) + anvil-tui (catalogue/surface) per ADR-054; spec contract `@eddacraft/render` (`packages/libs/render/`); extends TDASH `anvil dashboard`. DASHAI parallel, not blocking                                                                      |
...
| [realtime-ai-validation](./modules/realtime-ai-validation.aps.md)         | RTAI    | In Progress | 6/9                                                                                                               | A1 launch slice complete: RTAI-001 (spike), -002 (PR #1186), -003 (PR #1189), -006 (PR #1190), -008 (PR #1188) merged 2026-04-29/30. A2 Wave 3: RTAI-004 (PR #1311) merged 2026-05-06. RTAI-007 + -009 **Ready** (promoted 2026-06-02 — -007 deps RTAI-002/INTD-013/INTD-015 all Complete; -009 doc-only, scoped to shipped surfaces; both daemon-independent 0.8.0 freight). RTAI-005 (editor-driver path) stays **parked under ADR-033**.                                                              |
