...
| Daemon-working product slate | Current candidate | MLP 7/17 (In Progress; MLP-001 + MLP-002 + MLP-007 + MLP-011 + MLP-012 + MLP-013 + MLP-017 Done 2026-05-13 — Wave 1 closed and Wave 2 in flight with MLP-007 baseline + MLP-012 rules_sha primitives), INTL 0/9 (Ready, ready-to-start-Wave-3), carry-forward gates 6/6 confirmed (Wave 0 closed 2026-05-13) | Next tag candidate `v0.7.0-beta`; MLP-009 remains the hard release gate for any full-protection claim. Wave 2 in flight per `RELEASE-PLAN.md`. |
...
| ---- | ------ | -------- | ----- |
| N1 — Multi-Layer Protection v1 (MLP) | In Progress | 7/17 | Witness chain + hooks + L4 policy + baseline + multi-agent coord + rule distribution. New crates: `anvil-witness`, `anvil-config`, `anvil-rules`, `anvil-baseline`, `anvil-hook`, `anvil-l4`, `anvil-attribution`. **Hard gate: MLP-009.** Promoted from Proposed during Wave 0 readiness review (2026-05-13). Wave 1 complete (MLP-001 / -002 / -011 / -013 / -017 Done 2026-05-13). Wave 2 in flight: MLP-012 already merged via PR #1489 (`crates/anvil-rules/`; 29 tests green incl. yaml/json/toml cross-format determinism); this PR adds MLP-007 via `crates/anvil-baseline/` (Baseline schema + move-resistant fingerprint + TOCTOU-hardened I/O + diff partition; 44 tests green). Remaining Wave 2 items: MLP-003 pre-commit hook, MLP-005 post-* hooks, MLP-006 L4 policy framework, MLP-008 hook bootstrap. |
...
| Module                                                                      | Scope | Status      | Progress           |
| --------------------------------------------------------------------------- | ----- | ----------- | ------------------ |
| [continuous-improvement-backlog](./modules/continuous-improvement-backlog.aps.md) | CIB   | In Progress | 1/2                |
| [codebase-maintenance](./archive/modules/codebase-maintenance.aps.md)       | MAINT | Complete    | 11/11 (1 deferred) |
