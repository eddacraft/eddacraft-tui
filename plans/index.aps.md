...
| [daemon-save-time-validation](./modules/daemon-save-time-validation.aps.md)     | DSV    | In Progress | 16/18 (v0.8.0-beta daemon save-time arc; Sub-phase A 9/9 + A-W 2/2 Merged, DSV-044 Done 2026-06-08 — assurance/fence telemetry producer activation now routes through the production broadcaster/fanout with status counters; A′/B gated on GV2 hot-read + warm-start impl; sub-phase + PR detail in the module file) |
