...
| [bare-ensure](./modules/bare-ensure.aps.md)                             | ONSW    | In Progress | 6/6  | Bare `anvil` daily on-switch: daemon + existing MCP ensure without reinstall or re-offer; `anvil start` stays activate/reconfigure. [ADR-114](./decisions/114-bare-anvil-ensure-surface.md) **Accepted**; PR #3474 automerge queued. ONSW-001..006 Done on PR #3474; JOURNEY-011 after merge evidence. |
