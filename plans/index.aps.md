...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 7/11       | **Ready — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002/-003/-004/-006/-007/-011 Merged (#3975/#3976/#4027/#4031/#4040/#4051/#4009). DOCRB-005 and DOCRB-008 now have all dependencies Merged but remain Draft pending current readiness evidence; DOCRB-005 is the next dependency-ordered candidate. The live sidebar unhide and live-nav check no longer wait on diagram work. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
