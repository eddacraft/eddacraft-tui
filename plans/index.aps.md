...
at 48/68 after Group K (MLP2-053..-056) and Group L (MLP2-059) were marked Merged post-merge on 2026-05-16. MLP2-025 was split into MLP2-025 + MLP2-025b + MLP2-025c during the daemon-control wiring; the Stats footer counts each sub-task separately. After the full MLP/MLP2 Council audit reopened MLP2-016 and MLP2-048
...
| [adoption-friction](./modules/adoption-friction.aps.md)                 | ADOPT    | In Progress | 2/6 | First-week friction removal. **ADOPT-005 `anvil uninstall` merged 2026-05-14 (PR #1521), Released/Shipped via [`v0.6.3-beta`](./releases/v0.6.3-beta.md) on 2026-05-15; ADOPT-001 hook coexistence Done 2026-05-15** (runbook at `docs/runbooks/anvil-hook-coexistence.md`); resource budget (-002 In Progress), AI auto-detect (-003 In Progress), shared ignore (-004), editor coexistence (-006) remain. Wave 3A. |
