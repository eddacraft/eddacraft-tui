...
| [cli-command-truth](./modules/cli-command-truth.aps.md)                                                 | CLICT     | 0/7        | CLI command documentation vs runtime audit — **In Progress** (runtime registry + slices 1–6 audited; CLICT-001..006 Ready: architecture, policy/POLRESET, drift, watch, gate, intercept/workspace; CLICT-007 Proposed: tier-2 runbook sweep; `docs/reviews/cli-command-truth-review.md`) |
