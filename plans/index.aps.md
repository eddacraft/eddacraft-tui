...
| [documentation-governance](./modules/documentation-governance.aps.md)                                 | DOCGOV     | 3/8        | APS-linked operational knowledge architecture and agent closeout governance — **In Progress** (DOCGOV-001 establishes the docs-workflow and closeout rules; DOCGOV-002 adds the documentation taxonomy and metadata convention; DOCGOV-003 aligns APS public docs, local rules, and the package schema/parser contract; remaining items cover ADR repair, validation, freshness, generated indexes, and stale-entrypoint migration)                                  |
