...
| [scan-performance](./modules/scan-performance.aps.md)                           | SCAN   | In Progress | 4/6 (SCAN-001/-002/-003 landed as one slice — parallel-scan rollout, ReDoS line-length guard, first-run rayon pool cap; SCAN-004 Merged 2026-05-27 via PR #2021 — welcome `files_skipped_by_ignore` provenance; SCAN-005 In Progress (2026-05-28, `WalkParallel` benchmark spike — 4.5–6.3× walk speedup, ~10–17% end-to-end, refactor deferred to SCAN-006); SCAN-006 added (refactor `scan_project` to `WalkParallel`, Proposed))                                                                                                                                                                                                         |
