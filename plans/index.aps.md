...
| 4 | DOCRB-006 — central cross-system and operational diagrams | Ready | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [corpus disposition](./specs/2026-08-17-docrb-corpus-disposition.md) | The pilot is merged; the dependency-ready central view rebuild now removes stale cross-system authority before migration. Not a release claim. | Rebuild the bounded central views and retire obsolete diagram authorities. |
