...
| [daemon-lifecycle](./modules/daemon-lifecycle.aps.md)                           | DLIFE  | In Progress | 2/6 (DLIFE-001 Done — ADR-082 Accepted 2026-06-15 with the tiered startup mode: `anvil start` auto-starts the daemon; `anvil watch` prompts in TTY and falls back headless. ADR-079 superseded. DLIFE-006 — terminating `--verify` diagnostic for the daemon-unreachable case (#2609) — Merged via #2639. DLIFE-002 Ready; DLIFE-003/-004 Proposed.) |
