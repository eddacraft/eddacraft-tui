...
| ---- | --- | ---- | ------ | ------- | ----------- |
| 1 | v0.9 graph substrate — GV2-026 / -030 (contracts GV2-013/-014 Merged) | Ready | [graph-v2-foundation](./modules/graph-v2-foundation.aps.md) + [`RELEASE-PLAN.md`](../RELEASE-PLAN.md) | The assistant-facing-graph window's internal substrate: GV2-013 (control/session contract) **Merged 2026-06-13 via #2578** and GV2-014 (plan/provenance contract) **Merged 2026-06-13 via #2579** complete Phase 1; GV2-026 (reverse-impact depth lever) and GV2-030 (sealed-DTO no-leak guard) remain Ready — deps Merged, execution-ready, and **not** behind the ADR-075 GCTX entry gate (that covers the assistant-facing egress surface only). | Pick up GV2-026/-030 through dev-workflow — they code against concrete `cargo test` targets. |
...
| 3 | USAGE-001 — `command.invoked` Kindling observations | In Progress | [usage-analytics](./modules/usage-analytics.aps.md) + [`RELEASE-PLAN.md`](../RELEASE-PLAN.md) | Founder-requested (2026-05-10) durable "who is using what" evidence; In Progress 2026-06-14 — CLI producer + new `command.invoked` kind + privacy contract landed; JSON-RPC producer descoped to USAGE-004. Scoped into the `v0.9.0-beta` window as additive work (operator, 2026-06-13). | Mark Merged on PR merge; USAGE-002/003/004 follow. |
...
module family** — Graph Substrate (GV2, now 15/20 with the A′ slice shipped
and the v0.9 control/session + plan/provenance contracts Merged — Phase 1 complete), Hardening & Maintenance (DSV, Sub-phase B
...
| ------ | ----- | ------ | -------- | ------------ |
| [graph-v2-foundation](./modules/graph-v2-foundation.aps.md) | GV2 | In Progress | 15/20 (A′ slice shipped in v0.8.0-beta; Phase 1 complete — GV2-013 control/session contract Merged 2026-06-13 via #2578 and GV2-014 plan/provenance contract Merged 2026-06-13 via #2579; GV2-026/-030 Ready; GV2-020/-023 + GCTX stay Draft pending their deps / the entry decisions) | KERN, anvil-graph-cache, ADR-061/063/064/067/069, ADR-031, INTD, GCTX, EDDA |
...
| Module                                                                      | Scope | Status      | Progress           |
| --------------------------------------------------------------------------- | ----- | ----------- | ------------------ |
| [continuous-improvement-backlog](./modules/continuous-improvement-backlog.aps.md) | CIB   | In Progress | 44/71 (standing continuous-improvement intake; recent CIB-041..-046 release-reliability + flag-gating items Merged/Ready; CIB-054/-055 pre-tag v0.8.0 changelog-wording + release-plan-table reconcile Merged 2026-06-10 via PRs #2493/#2496; CIB-056 driver-client Windows pipe SID gate Merged via PR #2485 (#2484 increment 2 remains); CIB-057 capsule as-built doc + CIB-058 v0.8.0-window as-built delta refresh Merged 2026-06-10; CIB-059/-060 beta user-journey walkthrough follow-ups (quickstart ADR-080 ordering + auth-wall access pointer) In Progress 2026-06-11; CIB-061 remaining as-built delta refresh Merged via PR #2526; CIB-065 schema $id domain drift Merged 2026-06-11 via PR #2539; CIB-062..-064 golden-path polish gaps (auth-gate WARN JSON on stderr + install.sh docs URL + double-reported planted secret) Merged 2026-06-11 via PRs #2529/#2528/#2530; CIB-071 migrate user-facing diagnostics to miette (Todo 2026-06-14); per-item status in the module file) |
...
| Module                                              | Scope | Status | Progress | Dependencies                                                                                                                                                                                                                |
| --------------------------------------------------- | ----- | ------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [usage-analytics](./modules/usage-analytics.aps.md) | USAGE | In Progress | 0/4 | Kindling, TRACE-001 (consumes `TraceContext`); coordinates with TRACE-004 (incoming `traceparent` binding), FLAGCAT-007 / ADR-041 (resolved: inline `flag_set`, manifest `key` join, ADR-019 unchanged), TRACE-003 (shared `SENSITIVE_FIELDS` deny-list), OBS-001 (post-launch). Privacy contract + OQ2 anonymisation (hash + per-deployment salt) confirmed 2026-05-11. USAGE-001 In Progress 2026-06-14 — CLI producer + `command.invoked` kind + privacy contract; OQ1 → new kind; JSON-RPC producer descoped to USAGE-004 (no principal/resolver on the daemon path). USAGE-002/003 stay Draft. |
