...
| N5 — Adoption Trust Surface (ADTRUST) | In Progress | 0/6 | Make the protection claim legible and verifiable during sustained daily use. `anvil status` legibility (-001 In Progress on `feat/adtrust-001-status-legibility`), degraded-state surfacing (-002), `anvil doctor --fix` (-003), daemon-down auto-recovery (-004), `anvil status --json` schema pin (-005), first-run claim summary (-006). Promoted **Proposed → Ready** 2026-05-14 alongside acceptance of the v0.7.0 sit-on spec; ADTRUST-001 picked up 2026-05-14 (Wave 3B). Module ID disambiguated from `trust-center-automation` (already uses `TRUST`). |
...
| ----------------------------------------------------------------------- | -------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [adoption-trust-surface](./modules/adoption-trust-surface.aps.md)       | ADTRUST  | In Progress | 0/6      | Make the protection claim legible and verifiable in sustained daily use. Wave 3B. ADTRUST-001 picked up 2026-05-14 on `feat/adtrust-001-status-legibility`.                                        |
