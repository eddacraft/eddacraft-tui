...
| [dev-acceleration-benchmarks](./modules/dev-acceleration-benchmarks.aps.md)     | DEVACC | Ready       | 6/12 (Tier A Done 2026-08-11 on `feat/devacc-complete`: catalogue, runner, fixtures, navigate/edit/guard Tier A scripts. Tier B / planning claims / opt-in automation remain Draft/Proposed — stop after Tier A.)                                                                                                |
