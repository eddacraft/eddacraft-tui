...
| [scanner-adjacent-ts-retirement](./modules/scanner-adjacent-ts-retirement.aps.md) | TSGAP  | In Progress | 8/9 (post-TSRET remediation owner reconciled 2026-05-12: core exports cleaned; compiler moved to active `anvil-format`; drift/export/suppression ownership settled on Rust CLI/local readers; AP-* explanations explicitly retired until Rust explain lands; RMCPF now maps MCP resources to Rust-owned sources; remaining work is final audit)                                                                                                                                                                                                                                           |
