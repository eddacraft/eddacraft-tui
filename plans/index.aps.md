...
| [git-config-hooks](./modules/git-config-hooks.aps.md) | GHOOK | 3/6 | crates/anvil-cli, crates/anvil-tui, docs/public/anvil/, Git 2.54 hook API — **In Progress** (GHOOK-001 baseline + rollout policy; GHOOK-002 `--config` install/uninstall landed; GHOOK-006 public docs sweep landed) |
