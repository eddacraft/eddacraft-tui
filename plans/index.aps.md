...
| [usage-insights](./modules/usage-insights.aps.md)                       | INSIGHTS | In Progress | 4/4      | Local-only periodic value signal (`anvil insights`); INSIGHTS-001 Done 2026-05-17; -002 (#1996) + -003 (#2111) Released/Shipped via v0.7.3-beta 2026-05-31; -004 implemented on feat/insights-004 (first-week nudge surfaces in `status` + watch; `anvil insights` run suppresses; tests pass; path recon applied). No telemetry.                                            |
