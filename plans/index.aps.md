...
| Module | Scope | Status | Progress | Dependencies |
| ------ | ----- | ------ | -------- | ------------ |
| [intercept-daemon](./modules/intercept-daemon.aps.md) | INTD | In Progress | 2/16 complete, 2 committed (INTD-002, INTD-005) | anvil-checks, anvil-kernel (watcher), INTR, INTL, NOTIFY |
