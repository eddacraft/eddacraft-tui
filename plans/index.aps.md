...
| 4 | DOCRB-007 — Draw.io-to-accessible-SVG public asset pipeline | Schedule | [docs-rebaseline](./modules/docs-rebaseline.aps.md) | Its DOCRB-001/-002 dependencies are merged, but the item remains Draft until expected evidence is present. Not a release claim. | Confirm expected evidence and promote explicitly; dependency satisfaction alone does not make it Ready. |
...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 6/11       | **Ready — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002/-003/-004/-006/-011 Merged (#3975/#3976/#4027/#4031/#4040/#4009). DOCRB-007's dependencies are satisfied, but it remains Draft until expected evidence is present. The live sidebar unhide and live-nav check no longer wait on diagram work. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
