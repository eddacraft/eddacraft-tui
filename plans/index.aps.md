...
| 3 | CIB-281 — audit security scope on TUI + SARIF | Ready | [CIB](./modules/continuous-improvement-backlog.aps.md) | Completes CIB-234 disclosure; Ready leftover from the 0.9.3 honesty class. | Surface SECURITY_SCOPE (or equivalent) on TUI/SARIF audit paths; candidate for provisional `v0.9.4-beta`. |
| 4 | Provisional v0.9.4-beta — field follow-up | Schedule | [RELEASE-PLAN](../RELEASE-PLAN.md) | Keeps one untagged active window after 0.9.3 closeout; claim not frozen. | Intake post-0.9.3 field signal; lock primary claim before implement/cut. |
...
| 6 | v0.9.3-beta claim set | Released/Shipped | [release record](./releases/v0.9.3-beta.md), [CIB](./modules/continuous-improvement-backlog.aps.md) | Honesty + Windows window published 2026-08-07; APS items advanced at closeout. | None — historical. |
