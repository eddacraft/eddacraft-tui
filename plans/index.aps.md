...
| 4 | DOCRB-006 — central cross-system and operational diagrams | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [action plan](./execution/DOCRB-006.actions.md), [corpus disposition](./specs/2026-08-17-docrb-corpus-disposition.md) | The pilot is merged; the bounded central rebuild is executing against current source before migration. Not a release claim. | Complete the five source-traced views, retire obsolete authorities, then run independent verification and Council. |
...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 5/11       | **Ready — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002/-003/-004/-011 Merged (#3975/#3976/#4027/#4031/#4009). DOCRB-006 is Ready for the bounded central cross-system and operational diagram rebuild. The live sidebar unhide and live-nav check no longer wait on diagram work. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
