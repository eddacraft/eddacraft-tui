...
| [mcp-2026-07-28-dual-era-support](./modules/mcp-2026-07-28-dual-era-support.aps.md) | MCP26 | In Progress | 0/11 (filed 2026-07-27 on `feat/mcp26-dual-era-support`. Dual-era stdio for modern MCP `2026-07-28` plus sealed legacy initialise-era clients. **MCP26-001 In Progress** — RC lock, draft inventory, provisional matrix, and ADR-113 Proposed; blocked on final schema publish 2026-07-28 and stable `rmcp` v3 or temporary adapter closeout. No wire merge to main until gate closes.) | RMCPF, MCPX, ACTMO; final MCP `2026-07-28`; ADR-113; `rmcp` v3 or typed adapter |
