...
| [security](./modules/security.aps.md)                                                                 | SEC        | 2/9        | CI pipeline, cargo audit, pnpm audit — **In Progress** (SEC-007 token-revocation atomicity, GH #1672; SEC-008 named-pattern secret detection for AWS / GitHub PAT / Slack tokens **Merged 2026-05-21 via PR #1815**, GH #1800; SEC-009 private docs entitlement gate for signed licences, GH #1673, Done 2026-05-28) |
