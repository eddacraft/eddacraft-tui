...
| 4 | DOCRB-009 — mandatory diagram review and enforcement | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [design](./specs/2026-08-16-docs-rebaseline.md) | All dependencies are Merged; the approved 35-path plan composes existing docs checks, triggered freshness closeouts, and CI/local routing without a new required status. | Execute DOCRB-009 in its claimed fresh Worktrunk; keep DOCRB-010 Draft. |
