...
| [daemon-lifecycle](./modules/daemon-lifecycle.aps.md)                           | DLIFE  | In Progress | 1/6 (DLIFE-001 Done — ADR-082 Accepted 2026-06-15 with the tiered startup mode: `anvil start` auto-starts the daemon; `anvil watch` prompts in TTY and falls back headless. ADR-079 superseded; DLIFE-002/-003/-004 unblocked. DLIFE-006 — a terminating `--verify` diagnostic for the daemon-unreachable case (#2609) — remains independently shippable.) |
