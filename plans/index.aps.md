...
| [eval-regression-ci-gate](./modules/eval-regression-ci-gate.aps.md)               | EVALCI  | Ready    | eval-harness-integration (EVAL, Done — items Merged via #3013); rust-tests.yml Test job; ATC-003 for suite depth (001-004 Ready; 005-008 Proposed)  |
