...
| N5 — Adoption Trust Surface (ADTRUST) | In Progress | 0/6 | Make the protection claim legible and verifiable during sustained daily use. `anvil status` legibility (-001 In Progress, PR #1531), degraded-state surfacing (-002 Draft), `anvil doctor --fix` (-003 Draft), daemon-down auto-recovery (-004 Draft), `anvil status --json` schema pin (-005 In Progress, PR #1532 stacked on #1531), first-run claim summary (-006 Draft). Promoted **Proposed → Ready** 2026-05-14 alongside acceptance of the v0.7.0 sit-on spec; ADTRUST-001 + ADTRUST-005 picked up 2026-05-14 (Wave 3B). Module ID disambiguated from `trust-center-automation` (already uses `TRUST`). |
...
| ----------------------------------------------------------------------- | -------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [adoption-trust-surface](./modules/adoption-trust-surface.aps.md)       | ADTRUST  | In Progress | 0/6      | Wave 3B. ADTRUST-001 PR #1531 (`feat/adtrust-001-status-legibility`); ADTRUST-005 PR #1532 stacked. Both picked up 2026-05-14.                                                                                                                                       |
