...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 2/11       | **Ready — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002 Merged (#3975/#3976). **DOCRB-011 Ready** (live sidebar unhide + live-nav check; split from DOCRB-008 so it does not wait on diagrams). DOCRB-003/-004 remain Draft. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
