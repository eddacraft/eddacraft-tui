...
| [opa-enhancements](./modules/opa-enhancements.aps.md)                             | OPAE    | Proposed | Reset 2026-07-02 to **Policy Authoring and Runtime UX**: regorus-backed user policy discovery/loading, local policy install UX, remediation-first guidance, save-time/pre-write input adapter, and `warn`/`fence`/`interrupt` routing contracts. Depends on POLRESET, POLVAL, CPOL, EXCEPT; no second production OPA runtime. |
...
| [policy-pack-validation](./modules/policy-pack-validation.aps.md)                 | POLVAL  | Proposed | POLENG/regorus, `crates/anvil-policy-engine` (pack admission home per ADR-098 retarget)                                                                                  |
