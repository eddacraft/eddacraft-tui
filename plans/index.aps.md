...
> the release: V050F (6/16 done), the daemon-backed RMCP path
...
| [v050-release-followups](./modules/v050-release-followups.aps.md)               | V050F  | In Progress | 6/16 (16 hardening items deferred from `v0.5.0-beta` release work: 10 from the council rounds, 1 from the copilot PR #1081 review, 3 from the v0.4.0-beta tag run + post-tag deploy — scoop PAT scope, winget gh arg regression, missing migration runner — 1 from the copilot PR #1090 review tracking the svix>uuid override exception, and 1 private-release Latest promotion fix; 6 done, 10 outstanding as post-release follow-ups) |
| [v060-release-candidates](./modules/v060-release-candidates.aps.md)             | V060F  | In Progress | 0/1 (capture-as-you-find module for items targeted at the next release after v0.5.0-beta; holds both council/post-tag deferrals and forward nominations from active modules; seeded 2026-05-01 with V060F-001 nominating RCLI2-009 for the slot) |
...
| [launch-flow-readiness](./modules/launch-flow-readiness.aps.md)           | LAUNCH  | In Progress | 5/16                                                                                                              | RCLI, KERN; coordinates with TUIDASH, DRVR, RMCP, RTAI, INTD; supersedes RTVS in part; adds upgrade/version UX, tutorial polish, repo language profile + filter                                                                                                                    |
...
| [rust-cli-tier2](./modules/rust-cli-tier2.aps.md)                         | RCLI2   | In Progress | 4/9                                                                                                               | RCLI; RCLI2-001..-004 shipped per 2026-04-26 freshness audit (commits 1e44ef2d / c5679432 / a2297dca / 06d764d4); -005..-008 still Proposed (gated on OPAE); -009 added 2026-05-01 (admin command parity — list/show/revoke/audit/send-migration/email-update)                    |
