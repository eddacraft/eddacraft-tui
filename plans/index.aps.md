...
| N6 — Adoption Friction Removal (ADOPT) | In Progress | 3/6 | Remove first-week adoption friction. **Hook coexistence (-001 Done 2026-05-15**, runbook at `docs/runbooks/anvil-hook-coexistence.md`), **CI-enforced resource budget (-002 Done 2026-05-16)**, AI tool auto-detect (-003 In Progress), complete ignore policy (-004 In Progress), **clean uninstall (-005) shipped 2026-05-14 via PR #1521**, editor coexistence matrix (-006). Promoted **Proposed → Ready** 2026-05-14. Lands in Wave 3A of `RELEASE-PLAN.md`. |
...
| [adoption-friction](./modules/adoption-friction.aps.md)                 | ADOPT    | In Progress | 3/6 | First-week friction removal. **ADOPT-005 `anvil uninstall` merged 2026-05-14 (PR #1521), Released/Shipped via [`v0.6.3-beta`](./releases/v0.6.3-beta.md) on 2026-05-15; ADOPT-001 hook coexistence Done 2026-05-15** (runbook at `docs/runbooks/anvil-hook-coexistence.md`); **resource budget (-002 Done 2026-05-16)**, AI auto-detect (-003 In Progress), shared ignore (-004 In Progress), editor coexistence (-006) remain. Wave 3A. |
