...
| [tui-dashboard-render](./modules/tui-dashboard-render.aps.md)             | TUIDASH | In Progress | 12/12 (TUIDASH-003..-012 — engine, components, charts, binding, surface + CLI, parity, responsive, previews — Merged 2026-06-02 via PR #2229; awaiting release) | eddacraft-tui (engine, feature-gated) + anvil-tui (catalogue/surface) per ADR-054; spec contract `@eddacraft/render` (`packages/libs/render/`); extends TDASH `anvil dashboard`. DASHAI parallel, not blocking                                                                      |
