...
| [usage-insights](./modules/usage-insights.aps.md)                       | INSIGHTS | In Progress | 4/5      | Local-only periodic value signal (`anvil insights`); INSIGHTS-001 Done 2026-05-17; -002 (#1996) + -003 (#2111) Released/Shipped via v0.7.3-beta 2026-05-31; -004 Released/Shipped via v0.8.0-beta (Merged 2026-06-02 via PR #2226 — first-week nudge in `status` + watch, suppressed after an `anvil insights` run; merge recorded retroactively 2026-06-12); -005 In Progress 2026-06-26 (nudge on the `welcome` surface, reusing the -004 hint contract; `feat/insights-005-welcome-nudge`). No telemetry.                                            |
