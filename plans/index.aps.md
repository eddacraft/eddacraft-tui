...
| [test-coverage-uplift](./modules/test-coverage-uplift.aps.md)               | TCOV  | In Progress | 19/25 (Phase 1+2 complete: 13/13; Phase 3: TCOV-014..-018 Merged (5), TCOV-019..-021 Blocked — needs decision: mcp-server archived under ADR-033 + excluded from workspace; Phase 4: TCOV-025 Merged, TCOV-022..-024 Blocked — scope drift, needs design refresh against the `eddacraft-tui` re-export + two-widget layout) | TFIX                    |
