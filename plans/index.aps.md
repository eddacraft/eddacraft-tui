...
| 2 | GCTX-001 assistant graph projection contract — the assistant-facing consumer surface | Ready | [graph-context-delivery](./modules/graph-context-delivery.aps.md) + [graph-v2-foundation](./modules/graph-v2-foundation.aps.md) | The assistant-facing **substrate is now built**: both ADR-075 entry decisions landed 2026-06-15 ([ADR-083](./decisions/083-gctx-mcp-delivery-target.md) + [PV-9 egress review](./reviews/2026-06-15-gctx-context-egress-privacy-review-verdict.md)), **GV2-023 consumer contract Merged via #2621** and **GV2-020 registry + typed query traits Merged via #2622**. GCTX (module Ready, 0/13) is the consumer that sits on that registry. | Pick up **GCTX-001** (projection contract) through dev-workflow — it folds the egress conditions CE-1..CE-12 (CE-1 + CE-5 are hard gates) and is the gate for the Phase 1 GCTX tools. GV2-031 (rank 1) is the last remaining internal GV2 item. |
...
| [graph-context-delivery](./modules/graph-context-delivery.aps.md) | GCTX | Ready | 0/13 (entry gates landed 2026-06-15 — ADR-083 Accepted + PV-9 egress review filed; GCTX-001 (contract) + GCTX-002 Ready 2026-06-15 (GCTX-001 dependency GV2-023 Merged 2026-06-15 via #2621); GCTX-003..013 stay Draft pending the GCTX-001 contract folding CE-1..CE-12) | GV2 |
