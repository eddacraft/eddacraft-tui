...
| [launch-flow-readiness](./modules/launch-flow-readiness.aps.md) | LAUNCH | In Progress | 1/6 | RCLI, KERN; coordinates with TUIDASH, DRVR; supersedes RTVS in part |
...
| [attribution-pipeline-v3](./modules/attribution-pipeline-v3.aps.md) | ATTRIB | 10 | tools/generate-acknowledgements.sh (v1 shipped), cargo-about, future deny.toml — **Draft** |
