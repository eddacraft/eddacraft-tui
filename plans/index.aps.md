...
| 4 | DOCRB-007 — Draw.io-to-accessible-SVG public asset pipeline | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [action plan](./execution/DOCRB-007.actions.md) | Exact-base evidence confirms the mounted families, renderer topology, pinned exporter, and validation path. Not a release claim. | Execute fixture-first pipeline slices; retain all stated public-authoring and enforcement exclusions. |
