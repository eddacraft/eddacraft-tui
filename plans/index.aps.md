...
| [cli-command-truth](./modules/cli-command-truth.aps.md)                                                 | CLICT     | 0/7        | CLI command documentation vs runtime audit — **In Progress** (runtime registry + slices 1–6 audited; CLICT-004..006 Done 2026-07-07: watch, gate vocabulary, intercept/workspace runbook reconciliation; CLICT-001..003 remain recorded In Progress pending bookkeeping; CLICT-007 Ready: tier-2 runbook sweep; `docs/reviews/cli-command-truth-review.md`) |
