...
| 4 | DOCRB-008 — public information architecture and curated diagrams | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [design](./specs/2026-08-16-docs-rebaseline.md) | All dependencies are Merged and the approved public information-architecture and curated-diagram rebaseline is In Progress. It is not a release claim. | Finish the bounded dev-loop through verification, Council, and PR; do not start DOCRB-009. |
