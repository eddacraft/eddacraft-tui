...
> and Dave pack-02 commissioning/TUI intake **CIB-251..267** (RETRACT-1;
> preserve pack-01 disposition). Pre-250 backlog promotions on the same honesty
> theme: **CIB-205** (attribution completeness), **CIB-214**, **CIB-100**,
> **CIB-160**. Auth wall intentionally not tracked. See
...
| 2 | CIB-250 — tutorial safety chain (esc-as-back → resume → wrong-repo activate) | Merged | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3578](https://github.com/eddacraft/anvil-001/pull/3578), [RELEASE-PLAN](../RELEASE-PLAN.md) | Tutorial safety chain on main (esc-as-back, scoped resume, activation write+decline); release evidence remains outstanding. | None before release verification. |
| 3 | CIB-252 + CIB-254 — pack-02 trust: register false success + daemon save-time silent miss | Merged | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3552](https://github.com/eddacraft/anvil-001/pull/3552), [#3577](https://github.com/eddacraft/anvil-001/pull/3577), [RELEASE-PLAN](../RELEASE-PLAN.md) | Register honesty and daemon save-time family-scoping/no-contact fixes are on main; release evidence remains outstanding. | None before release verification. |
| 4 | CIB-244 + CIB-245 — verdict Install shows chosen clients; grouped multi-step consent | Merged | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3543](https://github.com/eddacraft/anvil-001/pull/3543) | Shipped on main. | None. |
| 5 | CIB-220..225 — start honesty (MCP/auth/value/non-git/flags) | Merged | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3520](https://github.com/eddacraft/anvil-001/pull/3520), [#3522](https://github.com/eddacraft/anvil-001/pull/3522) | Shipped on main. | None. |
| 6 | CIB-226 + CIB-227 — public CLI docs + multi-client wording | Merged | [CIB](./modules/continuous-improvement-backlog.aps.md), [#3525](https://github.com/eddacraft/anvil-001/pull/3525) | Shipped on main. | None. |
| 7 | CGBDG-001..006 — council-gate bridge discovery | Ready | [council-gate-bridge](./modules/council-gate-bridge.aps.md), [Graph Trust Surfaces](./specs/2026-07-28-graph-trust-surfaces.md) | Still highest-value programme track after the 0.9.3 cut; not a 0.9.3 claim. | After 0.9.3 or in parallel if capacity; prefer thin witness-lines path. |
| 8 | CONF-001 — intent-conformance product ADR | Schedule | [intent-conformance](./modules/intent-conformance.aps.md), [programme §6](./specs/2026-07-28-graph-trust-surfaces.md#6-clearance-checklist-to-unlock-the-rest) | Unlocks Tier-0 claim-vs-delta demos on the live GV2 delta surface. | Author and accept CONF-001 ADR with Tier-0 carve-out (no full ILGOV wait). |
