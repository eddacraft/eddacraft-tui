...
| 2 | CIB-250 — tutorial safety chain (esc-as-back → resume → wrong-repo activate) | Ready | [CIB](./modules/continuous-improvement-backlog.aps.md), [RELEASE-PLAN](../RELEASE-PLAN.md) | P0 first-timer walkthrough: natural keys land irreversible activate on wrong repo. Dave pack-03 §3. | One PR chain: esc label/behaviour, menu escape, scoped resume, activation write+decline. Supersedes 258/265. |
