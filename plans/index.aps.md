...
| 6 | MCP26-012 — adopt official `rmcp` for protocol framing | Ready | [mcp-dual-era-support](./modules/mcp-dual-era-support.aps.md) | Dual-era host Merged via #3444; temporary typed adapter remains until product pin. | Bounded transport proof against §8.2; pin stable `rmcp`; remove temporary adapter. |
...
| ----------------------------------------------------------------------- | -------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [release-user-journeys](./modules/release-user-journeys.aps.md)         | JOURNEY | In Progress | 8/10 | **Conductor** for first-run advocacy and daily confidence. **v0.9.0-beta shipped 2026-07-12** under JOURNEY-006 (record: [v0.9.0-beta](./releases/v0.9.0-beta.md)). Post-cut: **JOURNEY-007 Merged 2026-07-30 via PR #3441** (WOW-006 sandboxed autoplay); **JOURNEY-008 Merged 2026-07-25 via PR #3408**; JOURNEY-009 on hold; JOURNEY-010 blocked on DASHARCH/DASHOPS. |
