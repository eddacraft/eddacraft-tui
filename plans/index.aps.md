...
| [dev-acceleration-benchmarks](./modules/dev-acceleration-benchmarks.aps.md)     | DEVACC | Done       | 12/12 (suite landed 2026-08-11 on `feat/devacc-complete`: catalogue + Tier A runner/fixtures/scenarios, Tier B dry-run + external driver contract, planning SCN-20–22, claims policy + SCN-40 scaffold, opt-in workflow default-off. Live model evidence optional follow-up.)                                                                                                |
