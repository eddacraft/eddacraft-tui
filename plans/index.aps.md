...
| [opa-enhancements](./modules/opa-enhancements.aps.md)                             | OPAE    | Draft    | POLENG/regorus, `crates/anvil-policy-engine`, `crates/anvil-policy`, `crates/anvil-kernel`, `crates/anvil-cli`, `crates/anvil-tui`; requires a Rust/regorus rewrite before Ready |
...
| [policy-pack-validation](./modules/policy-pack-validation.aps.md)                 | POLVAL  | Draft    | POLENG/regorus, `crates/anvil-policy`, `crates/anvil-policy-engine`                                                                                  |
...
| [eval-harness-integration](./modules/eval-harness-integration.aps.md)             | EVAL    | Ready    | `anvil policy eval --json` v1 (CIB-078), POLENG/regorus, OPAG guidance hooks when OPAG is promoted                                                  |
...
| [contextual-policy-assertions](./modules/contextual-policy-assertions.aps.md)     | CPOL    | Ready    | POLENG `PolicyInput` v1 + `crates/anvil-policy`; OPAG guidance is a downstream consumer                                                             |
| [io-risk-controls](./modules/io-risk-controls.aps.md)                             | IORISK  | Ready    | `crates/anvil-kernel-types`, `crates/anvil-policy`, POLENG result semantics                                                                         |
...
| [compliance-policy-packs](./modules/compliance-policy-packs.aps.md)               | CPACKS  | Draft    | POLENG/regorus, POLVAL, OPAE library/install UX, AGOV signals for AI-specific packs; Rego remains portable                                          |
