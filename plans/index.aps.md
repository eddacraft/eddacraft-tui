...
| 4 | DOCRB-010 — independent documentation re-baseline verification | In Progress | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [design](./specs/2026-08-16-docs-rebaseline.md) | DOCRB-009 is Merged via #4099; clean-room verification is active in the claimed Worktrunk under the approved four-path plan. | Execute the maintainer, contributor, operator, and public-reader journeys; preserve stored 10/11 until post-merge reconciliation. |
