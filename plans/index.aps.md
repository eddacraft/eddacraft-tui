...
| [feature-flag-catalogue](./modules/feature-flag-catalogue.aps.md)                                     | FLAGCAT    | 2/8        | Draft module. Depends on FLAGS and FLAGM; closed work so far is limited to the design note and ADR-041 decision contract. Implementation items FLAGCAT-002..-006 plus FLAGCAT-008 remain Draft; see the module file for item-level status and evidence. |
