...
| [activation-tui](./modules/activation-tui.aps.md)                     | ACTTUI   | Merged | 18/18 | TUI-first `anvil start` — all work items Merged. **ACTTUI-014** via #3478; completion programme **ACTTUI-015..017 Merged 2026-08-03 via PR #3488** ([spec](./specs/2026-08-03-activation-tui-completion.md)): honesty, Prove, start↔status posture. Awaits release evidence for Released/Shipped. Escape hatches: `--no-tui` / `ANVIL_NO_TUI=1`. |
