...
| 4 | DOCRB-008 — public information architecture and curated diagrams | Schedule | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [design](./specs/2026-08-16-docs-rebaseline.md) | All dependencies are Merged, making DOCRB-008 the next dependency-clear DOCRB candidate. It remains Draft pending its own readiness pass and is not a release claim. | Run a fresh readiness and design-truth pass; do not implement without explicit promotion. |
...
| [feature-flag-catalogue](./modules/feature-flag-catalogue.aps.md)                                     | FLAGCAT    | 8/15       | FLAGS and FLAGM complete; operational catalogue bootstrap and migrations shipped. FLAGCAT-008 remains Draft for the GA licence-gate review. FLAGCAT-010 is **In Progress** to ratify the definitive product-feature catalogue contract after the 2026-08-20 live audit. FLAGCAT-011..015 are Draft in dependency order: entity-schema design plus current product back-capture, host completeness gates, bidirectional flag linkage, generated views, then completeness-gated mapping to an approved potential Individual/Teams/Enterprise vocabulary — **In Progress** |
...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 8/11       | **In Progress — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002/-003/-004/-005/-006/-007/-011 Merged (#3975/#3976/#4027/#4031/#4055/#4040/#4051/#4009). DOCRB-008 is the next dependency-clear DOCRB candidate but remains Draft pending its own readiness pass; this closeout does not promote or implement it. The live sidebar unhide and live-nav check no longer wait on diagram work. Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
| [docs-definition-layer](./modules/docs-definition-layer.aps.md)                                      | DOCDEF     | 6/6        | **Done — exclusive definition-layer programme; not a release claim.** All six items Merged (#4028/#4030/#4034/#4037/#4035/#4036). Live IA/nav stays DOCRB. Design: [2026-08-19-anvil-docs-definition-layer.md](./specs/2026-08-19-anvil-docs-definition-layer.md). |
