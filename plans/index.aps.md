...
| 4 | DOCRB-011 — live public nav / unhide definition pages | Ready | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [definition-layer design](./specs/2026-08-19-anvil-docs-definition-layer.md) | Beta testers cannot find existing reference pages from the live sidebar. Not a release claim. | Execute live sidebar + unhide + live-nav check. |
...
| [docs-rebaseline](./modules/docs-rebaseline.aps.md)                                                  | DOCRB      | 2/11       | **Ready — high-priority engineering-effectiveness programme; not a release claim or cut gate.** DOCRB-001/-002 Merged (#3975/#3976). DOCRB-003 is In Progress for the advisory trigger and component-document standard; DOCRB-004 remains Draft. **DOCRB-011 Ready** (live sidebar unhide + live-nav check; split from DOCRB-008 so it does not wait on diagrams). Coordinates with DOCFRESH, DOCSYNC, DOCDEF, and DSITE without absorbing or closing their work. |
| [docs-definition-layer](./modules/docs-definition-layer.aps.md)                                      | DOCDEF     | 0/6        | **Ready — exclusive definition-layer programme; not a release claim.** Public evaluation model, generated check catalogue, source-cited config catalogue, CLI flags, and user-visible policy/boundary pages. Live IA/nav stays DOCRB-011. First content item DOCDEF-001 depends on DOCRB-011. Design: [2026-08-19-anvil-docs-definition-layer.md](./specs/2026-08-19-anvil-docs-definition-layer.md). |
