...
| 2 | ADR-114 / ONSW — bare `anvil` ensure surface | In Progress | [bare-ensure](./modules/bare-ensure.aps.md), [ADR-114](./decisions/114-bare-anvil-ensure-surface.md), [JOURNEY-011](./modules/release-user-journeys.aps.md) | Ship before `v0.10.0-beta`; ADR Accepted 2026-08-01; bare ensure implementation on `plan/bare-anvil-ensure`. | Land PR; green bare_invocation + ensure tests; JOURNEY-011 evidence. |
...
| 7 | MCP26-012 — adopt official `rmcp` for protocol framing | Ready | [mcp-dual-era-support](./modules/mcp-dual-era-support.aps.md) | Dual-era host Merged via #3444; temporary typed adapter remains until product pin. | Bounded transport proof against §8.2; pin stable `rmcp`; remove temporary adapter. |
...
`v0.9.0-beta` (2026-07-12) are fully shipped as promoted headline windows.
...
| ----------------------------------------------------------------------- | -------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [release-user-journeys](./modules/release-user-journeys.aps.md)         | JOURNEY | In Progress | 8/11 | **Conductor** for first-run advocacy and daily confidence. **v0.9.0-beta shipped 2026-07-12** under JOURNEY-006 (record: [v0.9.0-beta](./releases/v0.9.0-beta.md)). Post-cut: **JOURNEY-007 Merged 2026-07-30 via PR #3441** (WOW-006 sandboxed autoplay); **JOURNEY-008 Merged 2026-07-25 via PR #3408**; JOURNEY-009 on hold; JOURNEY-010 blocked on DASHARCH/DASHOPS; **JOURNEY-011 Proposed** (bare ensure vs start reconfigure — ADR-114 / ONSW). |
| [bare-ensure](./modules/bare-ensure.aps.md)                             | ONSW    | In Progress | 1/6  | Bare `anvil` daily on-switch: daemon + existing MCP ensure without reinstall or re-offer; `anvil start` stays activate/reconfigure. [ADR-114](./decisions/114-bare-anvil-ensure-surface.md) **Accepted** 2026-08-01; [spec](./specs/2026-08-01-bare-anvil-ensure.md). Conductor JOURNEY-011. ONSW-001 Done; implementing ONSW-002..006 for `v0.10.0-beta`. |
...
| [documentation-sync](./modules/documentation-sync.aps.md)                                             | DOCSYNC    | 16/23      | Public docs-site sync (`docs/public/anvil/`, `docs/public/kindling/`, `docs/public/aps/`) — **In Progress** (DOCSYNC-028 Merged 2026-07-20 via PR #3366. DOCSYNC-029 In Progress — APS first-time-user rebuild against anvil-plan-spec v0.6.0 with public-only language, complete intent-based navigation, and source-pinned command validation; plan: `plans/execution/DOCSYNC-029.actions.md`. DOCSYNC-030 In Progress — beta onboarding brief repair for update checks, GitHub/OTP sign-in evidence, executable test steps, and private feedback. Remaining Drafts: DOCSYNC-005 API reference, -011 Dashboard, -013 Multi-language, -016 VSCode/CI warning divergence; DOCSYNC-012 policy governance is In Progress.)                                                                                                                         |
...
| [mcp-dual-era-support](./modules/mcp-dual-era-support.aps.md) | MCP26 | In Progress | 11/12 (**MCP26-001..011 Merged 2026-07-30 via PR #3444** — dual-era stdio host for MCP `2026-07-28` on main under `crates/anvil-cli/src/mcp/protocol/`; ADR-113 Accepted. **MCP26-012 Ready:** adopt official `rmcp` after bounded transport proof; temporary typed adapter remains.) | RMCPF, MCPX, ACTMO; MCP `2026-07-28`; ADR-113; typed adapter; `rmcp` follow-up |
