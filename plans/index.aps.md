...
| [skill-packaging-distribution](./modules/skill-packaging-distribution.aps.md)     | SKPKG   | Done | Owner-approved beta distribution: embed a pinned customer-readable skill snapshot in Anvil, default interactive installs to user-global with project choice, and ship a managed cross-agent installer through SKPKG-008. All 8 items Done 2026-07-14 via PR #3328. Coordinates with MCPX and SKOBS-002. |
