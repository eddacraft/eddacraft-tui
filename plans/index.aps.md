...
| [scan-performance](./modules/scan-performance.aps.md)                           | SCAN   | In Progress | 3/5 (SCAN-001/-002/-003 landed as one slice — parallel-scan rollout, ReDoS line-length guard, first-run rayon pool cap; SCAN-004 In Progress (2026-05-27, welcome `files_skipped_by_ignore` provenance); SCAN-005 deferred per Council E "smallest viable cut")                                                                                                                                                                                                         |
