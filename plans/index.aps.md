...
at 49/68 after Group K (MLP2-053..-056) and Group L (MLP2-059) were marked Merged post-merge on 2026-05-16, and MLP2-048 was re-closed on 2026-05-16 via branch `feat/mlp2-048-status-daemon-snapshot` after the reopened HARD-GATE render surface was wired through the daemon snapshot. MLP2-025 was split into MLP2-025 + MLP2-025b + MLP2-025c during the daemon-control wiring; the Stats footer counts each sub-task separately. After the full MLP/MLP2 Council audit reopened MLP2-016 and MLP2-048
