...
| [documentation-sync](./modules/documentation-sync.aps.md)                                             | DOCSYNC    | 16/22      | Public docs-site sync (`docs/public/anvil/`, `docs/public/kindling/`, `docs/public/aps/`) — **In Progress** (DOCSYNC-028 In Progress — structured first-time-user rebuild with one canonical journey, lowercase product names, public-only language, source-derived references, complete navigation, and enforceable trust boundaries; implementation plan: `plans/execution/DOCSYNC-028.actions.md`. Prior release-sync items DOCSYNC-023 through DOCSYNC-027 are Done. Remaining Drafts: DOCSYNC-005 API reference, -011 Dashboard, -013 Multi-language, -016 VSCode/CI warning divergence; DOCSYNC-012 policy governance is In Progress.)                                                                                                                         |
