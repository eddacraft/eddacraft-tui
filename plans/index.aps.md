...
| [tui-dashboard-render](./modules/tui-dashboard-render.aps.md)             | TUIDASH | Ready       | 0/12                                                                                                              | eddacraft-tui (engine, feature-gated) + anvil-tui (catalogue/surface) per ADR-053; spec contract `@eddacraft/render` (`packages/libs/render/`); extends TDASH `anvil dashboard`. DASHAI parallel, not blocking                                                                      |
