...
| Daemon-working product slate | Current candidate | MLP 11/17 (In Progress; Wave 1 + Wave 2 Done 2026-05-13: MLP-001 / -002 / -003 / -005 / -006 / -007 / -008 / -011 / -012 / -013 / -017), INTL 0/9 (Ready, ready-to-start-Wave-3), carry-forward gates 6/6 confirmed (Wave 0 closed 2026-05-13) | Next tag candidate `v0.7.0-beta`; MLP-009 remains the hard release gate for any full-protection claim. Wave 2 in flight per `RELEASE-PLAN.md`. |
...
| ---- | ------ | -------- | ----- |
| N1 — Multi-Layer Protection v1 (MLP) | In Progress | 11/17 | Witness chain + hooks + L4 policy + baseline + multi-agent coord + rule distribution. New crates: `anvil-witness`, `anvil-config`, `anvil-rules`, `anvil-baseline`, `anvil-hook`, `anvil-l4`, `anvil-attribution`. **Hard gate: MLP-009.** Promoted from Proposed during Wave 0 readiness review (2026-05-13). Wave 1 complete (MLP-001 / -002 / -011 / -013 / -017 Done 2026-05-13). Wave 2 in flight: MLP-012 already merged via PR #1489 (`crates/anvil-rules/`; 29 tests green incl. yaml/json/toml cross-format determinism); Wave 2 library primitives merged via #1489 / #1490 / #1491 / #1492. This PR completes Wave 2 by adding MLP-005 + MLP-008 to `crates/anvil-hook/` (post + bootstrap modules) and shipping the user-facing `anvil hook pre-commit/post-commit/post-merge/post-rewrite/bootstrap` and `anvil baseline [verify\|--refresh]` CLI subcommands; `anvil-witness` extended with `parent_commits[]` / `prev_line_hashes[]` for DAG-aware merge writes. |
