...
| [release-orchestration](./modules/release-orchestration.aps.md)                 | RELORCH | In Progress | 1/11 (RELORCH-001 completed 2026-05-10 with `plans/specs/2026-05-10-release-orchestration-design.md`. Phase 1 nucleus remaining: -002 harness, -003 assess, -004 preflight, -010 closeout, -011 wire-up + decommission. Phase 2: -005..-009 prepare/promote/tag/monitor/verify. Successor to archived RELMGMT; supersedes parts of `2026-04-20-relmgmt-agent-driven-release-design.md` while inheriting its no-persistent-manifest tradeoff as a hard constraint. Tracks the work to honour PR #1368's `scripts/release/*.sh` target surface; design now precedes implementation — see Council session `plan-9a6b3a94` 2026-05-09.) |
