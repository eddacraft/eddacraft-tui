...
| Operating model migration | In Progress | OPMODEL 10/12 | Completed: migration map, branching/worktree guidance, APS lifecycle/release metadata, release-record schema, release-readiness workflow design, release runbook/skill boundary, deterministic guidance, review/council entrypoints, workflow session/event schema, and warning-mode drift checks. Next: rollback playbooks, then cutover. |
