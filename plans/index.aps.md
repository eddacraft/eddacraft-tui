...
| [anvil-file-format](./modules/anvil-file-format.aps.md) | ANVFMT | In Progress | 13/16 (format + compiler + all rule .anvil files + scanner wiring + legacy HTML/CSS retired; pr-description scanning, docs refresh pending) |
