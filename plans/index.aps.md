...
| [mcp-dual-era-support](./modules/mcp-dual-era-support.aps.md) | MCP26 | In Progress | 0/12 (filed 2026-07-27 on `feat/mcp26-dual-era-support`. Final MCP `2026-07-28` contract sealed 2026-07-29; ADR-113 Accepted. Dual-era stdio host, activation, tests, benchmark drivers, docs, and local evidence are review-ready; PR platform CI remains. **MCP26-012 Ready:** adopt `rmcp` after a bounded transport passes §8.2.) | RMCPF, MCPX, ACTMO; MCP `2026-07-28`; ADR-113; typed adapter; `rmcp` follow-up |
