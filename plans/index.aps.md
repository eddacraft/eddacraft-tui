...
| 4 | DOCRB-010 — independent documentation re-baseline verification | Schedule | [docs-rebaseline](./modules/docs-rebaseline.aps.md), [design](./specs/2026-08-16-docs-rebaseline.md) | DOCRB-009 is Merged via #4099, satisfying the last dependency. Independent verification is the next programme candidate but remains Draft pending a readiness pass. | Run readiness only; do not start or implement DOCRB-010 without separate approval. |
