...
- Eval harness framework
  ...
  - Module: `plans/modules/eval-harness-integration.aps.md`
...
- Contextual policy assertion pattern
  - Module: `plans/modules/contextual-policy-assertions.aps.md`
- IO risk control/scanner taxonomy pattern
  - Module: `plans/modules/io-risk-controls.aps.md`
...
- Adversarial probe catalog pattern
  - Module: `plans/modules/adversarial-testing-catalog.aps.md`
