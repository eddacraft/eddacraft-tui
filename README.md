...
| ------ | --------- | ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------- |
| README | Advisory  | DOCGOV | Live   | Reviewed 2026-08-03 against `v0.9.1-beta`, `plans/releases/v0.9.1-beta.md`, installed CLI help, and current repository operations |
