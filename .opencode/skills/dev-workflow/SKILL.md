...
**After PR open / merge / abandon / pause:** → offer `wt remove`; perform
cleanup only after confirming the branch is pushed or safely merged, and only
with user approval for unmerged work
