...
## UK English Required
Use UK spelling: organised, recognised, colour, behaviour, optimise, centre, analyse, initialise, serialise.
...
2. **After schema changes**: Run `pnpm -F core run generate:schema` then `update-golden-hashes`
