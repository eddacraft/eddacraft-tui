...
Use Claude tools directly for APS reads/edits and the vendored
`.claude/agents/anvil-plan-spec.md` agent for non-trivial APS rewrites. Claude
slash commands such as `/plan` and `/council` may be used when they match the
