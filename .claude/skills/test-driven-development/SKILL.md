...
Use Claude command/agent surfaces where available, including `/test` or the
vendored/global `tdd-coach` agent for focused TDD help. Escalate unexpected test
failures to the debugger surface rather than speculative fixes.
