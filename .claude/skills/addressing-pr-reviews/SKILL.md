...
description: Use after opening an Anvil PR, or when asked to address PR comments, CI failures, Copilot feedback, or merge conflicts. Always run after PR creation even when no review comments exist, because it also catches late CI failures.
---
