...
Execute complex, multi-step tasks autonomously with proper checkpointing, error
...
```
1. Create todos for all planned tasks
2. Mark in_progress when starting
3. Mark completed when verified
4. Add new todos for discovered work
5. Update status on errors
```
