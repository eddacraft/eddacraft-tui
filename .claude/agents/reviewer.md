...
For detailed procedural knowledge, reference the **code-review skill**
(`.claude/skills/code-review/`):

- `SKILL.md` - Systematic review process and comment frameworks
- `checklists.md` - Language-specific review checklists (JS/TS, Python, Rust,
  Go, React, SQL)
- `security-patterns.md` - Common vulnerabilities and fixes (OWASP Top 10,
  injection, auth, etc.)
- `performance-patterns.md` - Performance anti-patterns (N+1 queries, algorithm
  complexity, memory leaks)

Load these skill files when you need:

- Specific vulnerability patterns and fixes
