...
pub const LANGUAGE_REGISTRY: &[LanguageEntry] = &[
    ...
    LanguageEntry {
        ...
        basis: "structural governance pending SURFSQL Phase 1",
    },
    LanguageEntry {
        name: "Markdown",
        extensions: &[".md", ".mdx"],
        coverage_tier: CoverageTier::Partial,
        basis: "secret checks ship; structural governance pending MDGOV",
    },
    LanguageEntry {
        name: "Python",
        extensions: &[".py", ".pyw"],
        coverage_tier: CoverageTier::Unsupported,
        basis: "PYLAN anchor not yet shipped",
    },
    LanguageEntry {
        name: "Rust",
        extensions: &[".rs"],
        coverage_tier: CoverageTier::Unsupported,
        basis: "RSTLAN anchor not yet shipped",
    },
    LanguageEntry {
        name: "Go",
        extensions: &[".go"],
