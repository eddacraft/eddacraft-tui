//! Sealed, allowlist-only warm-graph snapshot DTO and `postcard` codec
//! (GV2-030, ADR-069).
//!
//! Only explicitly listed fields serialise; unknown bytes fail closed. Disk I/O
//! and keys live in `anvil-intercept`; this crate owns the payload shape only.
