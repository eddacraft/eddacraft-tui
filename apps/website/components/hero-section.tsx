        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              />
              <span className="font-mono text-lg sm:text-xl uppercase tracking-[0.2em] sm:tracking-[0.3em] text-anvil">Anvil</span>
            </div>
            ...
            <div className="flex gap-4 sm:gap-8 pt-4 border-t border-structure">
              <div>
                ...
                <div className="font-mono text-[10px] sm:text-xs text-text-muted uppercase tracking-wider">gate latency</div>
              </div>
              <div>
                <div className="font-mono text-xl sm:text-2xl text-text-primary">100%</div>
                <div className="font-mono text-[10px] sm:text-xs text-text-muted uppercase tracking-wider">deterministic</div>
              </div>
              <div>
                <div className="font-mono text-xl sm:text-2xl text-edda">0</div>
                <div className="font-mono text-[10px] sm:text-xs text-text-muted uppercase tracking-wider">config drift</div>
              </div>
            </div>
          </div>
