...
| ------------ | --------- | --------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Architecture | Derived   | DOCRB/DSITE gap | Live   | Last reviewed 2026-08-22 against `apps/docs-shell/proxy.ts`, `apps/docs-shell/app/auth/**`, `apps/docs-shell/lib/**`, `flags/manifest.json`, and `infra/src/vercel.ts` |
