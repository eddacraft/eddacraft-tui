...
**Decision:** Plans describe *what*, not *how*.
...
**Example:**
```markdown
❌ "Create middleware using Express that extracts Bearer token
    from Authorization header, validates with jsonwebtoken..."
...
Plans don't specify *how* to implement:
