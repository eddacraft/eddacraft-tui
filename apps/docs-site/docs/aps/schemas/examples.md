...
The system returns a JWT valid for 24 hours.
...
Password strength requirements applied.
...
Requires auth for user context, inventory for stock checks,
and notifications for receipts.
```
