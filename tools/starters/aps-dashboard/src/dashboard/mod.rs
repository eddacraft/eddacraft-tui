...
// Starter-kit edit: the dashboard's only anvil-local import. Upstream this was
// `crate::surface::Surface`, which is just a re-export of the line below — the
// trait itself ships in the public `eddacraft-tui` crate.
