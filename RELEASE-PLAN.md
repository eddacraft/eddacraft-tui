...
| N2   | [`INTL`](./plans/modules/intercept-launcher.aps.md)         | Merged      | 9/9      | `anvil-run` launcher, session registration, process-group control, shell wrappers, side-channel register. Shipped via PR #1528 (merged 2026-05-14 at `5d38e546`).                                                                                                               |
