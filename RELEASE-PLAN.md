...
| Source                                                        | Open items                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`V050F`](./plans/modules/v050-release-followups.aps.md)      | 10/16 outstanding — hardening from `v0.5.0-beta` council (per-operator audit attribution, family-theft cascade, `/admin/approve` flag-gate, allowlist regex compile cache, eager rayon pool init, CI-class bench baseline, `release/*` push filter, `svix → uuid` override exception, etc.) |
