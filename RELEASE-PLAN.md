...
| ------------ | --------- | ----------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Release plan | Derived   | APS modules | Live   | Reconciled 2026-06-26 to module truth: the `v0.9.0-beta` feature scope is complete — all scoped modules (GCTX, GV2, USAGE, persistence/warm-start) Merged/Done. Active window: `v0.9.0-beta` (scope complete — awaiting cut). (Prior: 2026-06-13 operator scope confirmation; 2026-06-11 `v0.8.1-beta` closeout.) |
...
- **Active window:** `v0.9.0-beta` (below, **scope complete — awaiting cut**).
...
## Active window — `v0.9.0-beta` "The Assistant-Facing Graph" (scope complete — awaiting cut)
...
| GCTX starts coding before its entry decisions (GCTX-002, egress-privacy review) — the exact risk the ADR-075 council flagged. | **Discharged** — the entry decisions landed 2026-06-15 (ADR-083 Accepted + PV-9 egress review); GCTX then shipped entirely behind them (module 14/14, the sealed-DTO `GctxProjector` + CE-5 no-leak spine). |
