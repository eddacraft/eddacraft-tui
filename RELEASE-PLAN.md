...
| N2   | [`INTL`](./plans/modules/intercept-launcher.aps.md)         | In Progress | 0/9      | `anvil-run` launcher, session registration, process-group control, shell wrappers, side-channel register. Wave 3 implementation lane opened 2026-05-14 on `feat/intl-launcher-v1`.                                                                                              |
