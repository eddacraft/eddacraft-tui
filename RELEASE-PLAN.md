...
| ---- | ----------------------------------------------------- | ----------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| N1   | [`MLP`](./plans/modules/multilayer-protection.aps.md) | In Progress | 6/17     | Multi-layer protection backbone: project identity, witness chain, hooks, L4 policy, baseline, audit. Wave 1 complete (MLP-001 / -002 / -011 / -013 / -017 Done 2026-05-13). Wave 2 entered with MLP-012 rules_sha primitive (29 tests green).             |
...
| Work                                          | Parallel?         | Status            | Notes                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------------------------------------- | ----------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `MLP-012` `rules_sha` in witnesses            | After 002 (+ 011) | Done (2026-05-13) | Shipped as a new `crates/anvil-rules/` library: `RulesShaInput` + `rules_sha` over canonical JSON of `{anvil_version, config_sha, opa_runtime_version, rules}` + `RequiredAnvilVersion` semver-floor parser. 29 tests green incl. yaml/json/toml cross-format determinism. Daemon cache, hook fire-time floor check, L4 verification, and witness writer wiring deferred to consumers. |
| `MLP-003` pre-commit hook                     | After 002 + 012   | In flight         | First noisy surface; ADR-038 noise discipline applies from day one. Wires the rules_sha primitive into the witness append path.                                                                                                                                                                                                                                                        |
| `MLP-005` post-commit/post-merge/post-rewrite | After 003         |                   | Records commit-time state and handles merges/rebases/amends.                                                                                                                                                                                                                                                                                                                           |
| `MLP-006` L4 policy framework                 | After 002 + 007   |                   | Provides per-branch fallback policy for unwitnessed commits. Consumes `RequiredAnvilVersion` for the rules_sha-recognition check.                                                                                                                                                                                                                                                      |
| `MLP-007` baseline command                    | After 001 + 002   |                   | Enables adoption in existing repos without a warning storm.                                                                                                                                                                                                                                                                                                                            |
